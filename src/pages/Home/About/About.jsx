        ...
        <div className="hero min-h-screen bg-base-200">
            <div className="hero-content flex-col lg:flex-row">
                <Fade direction="left" duration={1200}>
                    ...
                    <img src={img11} className="rounded-lg shadow-2xl" />
                    <p className='px-10 py-5 text-center hidden md:block bg-orange-600 font-bold text-white rounded-lg shadow-2xl relative -left-72 -bottom-44'><span className='text-5xl font-bold'>10</span> <br />Years of <br /> Experience</p>
                </Fade>
